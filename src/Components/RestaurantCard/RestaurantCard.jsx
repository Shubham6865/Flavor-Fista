...
const RestaurantCard = ({ item, onClick }) => {
    ...
    return (
        <div
            className="p-1 hover:scale-90 hover:shadow-lg hover:border-0 hover:bg-gray-50 hover:text-gray-950 inline-block border border-gray-300 mt-2 text-gray-800"
            style={{ width: '204px' }}
            onClick={onClick} // Call the onClick handler passed from the parent
        >
